...
//      pour être plus prêt de l'âge moyen attendu
    ...
    //      Création de la date de naissance à partir des valeurs des trois comboboxes
			...
			$participant->naissance = ParticipantsController::construireDate($anneeNaissance, $moisNaissance, $jourNaissance);
	...
	// 			Il faut ajouter 1 aux valeurs pour obtenir la valeur attendue
