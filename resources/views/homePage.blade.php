...
@section('content')
	...
	<div class="jumbotron">
		...
		<a class="btn btn-lg btn-success" href="{{ action('SystemeController@index') }}" role="button">Système</a>
		...
		<a class="btn btn-lg btn-success" href="{{ action('ArbitresController@index') }}" role="button">Arbitres</a></p>
